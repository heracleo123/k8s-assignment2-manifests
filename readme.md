Cloud Architecture & Administration: Assignment 2Kubernetes Deployment, Orchestration, and Networking | Seneca Polytechnic
...
3. AWS ECR AuthenticationBashaws configure
...
🧹 CleanupBashkind delete cluster --name assignment2-cluster
